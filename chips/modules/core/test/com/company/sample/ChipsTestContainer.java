...
public class ChipsTestContainer extends TestContainer {

    public ChipsTestContainer() {
        super();
    ...
    public static class Common extends ChipsTestContainer {

        public static final ChipsTestContainer.Common INSTANCE = new ChipsTestContainer.Common();
