...
public class FishTestContainer extends TestContainer {

    public FishTestContainer() {
        super();
    ...
    public static class Common extends FishTestContainer {

        public static final FishTestContainer.Common INSTANCE = new FishTestContainer.Common();
